...
test('readFilesRecursively includes an extensionless file with a recognized shebang', async () => {
...
test('readFilesRecursively skips an extensionless file with no shebang (unchanged behavior)', async () => {
...
test('readFilesRecursively includes multiple shebang languages in the same directory', async () => {
...
test('readFilesRecursively does not add a detectedLanguage field for files with a real extension', async () => {
